 ...
 **/
public class CreateAlarmNodeHolderActor extends NodeHolderActor<DefaultNodeHolderProcessor> {
    
    public CreateAlarmNodeHolderActor(ActorSystemContext actorSystemContext, BiMap<NodeId, ActorRef> nodeIdBiMap, Map<NodeId, List<NodeMessageCarrier>> lockedFirstNodeIdVMap, Map<NodeId, NodeLifeCycleInfo> nodeLifeCycleMap) {
