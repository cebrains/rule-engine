 ...
 * @description:
 * @author: liwen
 * @create: 2019-05-09 22:14
 **/
public class RouterNodeHolderActor extends NodeHolderActor<DefaultNodeHolderProcessor> {
    
    public RouterNodeHolderActor(ActorSystemContext actorSystemContext, BiMap<NodeId, ActorRef> nodeIdBiMap, Map<NodeId, List<NodeMessageCarrier>> lockedFirstNodeIdVMap, Map<NodeId, NodeLifeCycleInfo> nodeLifeCycleMap) {
