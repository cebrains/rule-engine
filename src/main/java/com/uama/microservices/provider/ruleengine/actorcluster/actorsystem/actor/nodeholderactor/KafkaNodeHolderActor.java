 ...
 **/
public class KafkaNodeHolderActor extends NodeHolderActor<DefaultNodeHolderProcessor> {
    
    public KafkaNodeHolderActor(ActorSystemContext actorSystemContext, BiMap<NodeId, ActorRef> nodeIdBiMap, Map<NodeId, List<NodeMessageCarrier>> lockedFirstNodeIdVMap, Map<NodeId, NodeLifeCycleInfo> nodeLifeCycleMap) {
