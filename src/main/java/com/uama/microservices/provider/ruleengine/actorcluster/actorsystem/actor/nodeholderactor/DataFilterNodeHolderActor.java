 ...
 **/
public class DataFilterNodeHolderActor extends NodeHolderActor<DefaultNodeHolderProcessor> {
    
    public DataFilterNodeHolderActor(ActorSystemContext actorSystemContext, BiMap<NodeId, ActorRef> nodeIdBiMap, Map<NodeId, List<NodeMessageCarrier>> lockedFirstNodeIdVMap, Map<NodeId, NodeLifeCycleInfo> nodeLifeCycleMap) {
