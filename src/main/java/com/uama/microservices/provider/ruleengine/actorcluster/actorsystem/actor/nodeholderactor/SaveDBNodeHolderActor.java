 ...
 * @description:
 * @author: liwen
 * @create: 2019-05-09 22:16
 **/
public class SaveDBNodeHolderActor extends NodeHolderActor<DefaultNodeHolderProcessor> {
    
    public SaveDBNodeHolderActor(ActorSystemContext actorSystemContext, BiMap<NodeId, ActorRef> nodeIdBiMap, Map<NodeId, List<NodeMessageCarrier>> lockedFirstNodeIdVMap, Map<NodeId, NodeLifeCycleInfo> nodeLifeCycleMap) {
